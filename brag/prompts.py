...
Summarize the following brag doc, Format of the file: - [Date] [Project Name] Brag):
{content}
"""

GENERATE_RESUME_BULLETS_PROMPT = """
Generate resume bullet points from the following brag doc, Format of the file: - [Date] [Project Name] Brag):
{content}
"""
